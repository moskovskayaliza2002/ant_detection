...
if __name__ == '__main__':
    ...
    parser.add_argument('amound_of_data', nargs='?', default=50, help="Specify the number of generated images", type=int)
    parser.add_argument('im_size', nargs='?', default=(320,320), help="Specify the size of generated images", type=tuple)
    parser.add_argument('min_ants', nargs='?', default=7, help="Specify the minimum amound of ants per image", type=int)
    parser.add_argument('max_ants', nargs='?', default=11, help="Specify the maximum amound of ants per image", type=int)
    parser.add_argument('min_body_r', nargs='?', default=6, help="Specify the minimum radius of the body", type=int)
    parser.add_argument('max_body_r', nargs='?', default=11, help="Specify the maximum radius of the head", type=int)
