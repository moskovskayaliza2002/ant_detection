...
if __name__ == '__main__':
    ...
    parser.add_argument('min_ants', nargs='?', default=2, help="Specify the minimum amound of ants per image", type=int)
    parser.add_argument('max_ants', nargs='?', default=11, help="Specify the maximum amound of ants per image", type=int)
    parser.add_argument('min_body_r', nargs='?', default=3, help="Specify the minimum radius of the body", type=int)
    parser.add_argument('max_body_r', nargs='?', default=5, help="Specify the maximum radius of the head", type=int)
