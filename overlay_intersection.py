...
def verification(bboxes, kp, l1, l2, r1, r2, crop_w, crop_h, delta_w, delta_h, s_path, counter):
    l1_ants_counter, l1_noise, l1_bb, l1_kps = resize_bboxes_kps(bboxes, kp, 0, 0, crop_w + delta_w, crop_h + delta_h)
    ...
    l2_ants_counter, l2_noise, l2_bb, l2_kps = resize_bboxes_kps(bboxes, kp, 0, crop_h - delta_h, crop_w + delta_w, 2 * crop_h)
    ...
    r1_ants_counter, r1_noise, r1_bb, r1_kps = resize_bboxes_kps(bboxes, kp, crop_w - delta_w, 0, 2 * crop_w, crop_h + delta_h)
    ...
    r2_ants_counter, r2_noise, r2_bb, r2_kps = resize_bboxes_kps(bboxes, kp, crop_w - delta_w, crop_h - delta_h, 2 * crop_w, 2 * crop_h)
