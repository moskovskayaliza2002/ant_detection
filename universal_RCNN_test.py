...
if __name__ == '__main__':       
    ...
    parser.add_argument('test_data_path', nargs='?', default="/home/ubuntu/ant_detection/problems/FN_unalive/video0.mp4", help="Specify the path either to the folder with test images to test everything, or the path to a single image", type=str)
